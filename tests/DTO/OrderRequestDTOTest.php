...
use Mindbox\DTO\OrderRequestDTO;
...
',
    ...
    public function testGetCustomer()
    {
        ...
        $this->assertInstanceOf(\Mindbox\DTO\CustomerRequestV2DTO::class, $field);
    }
    ...
    public function testGetLines()
    {
        ...
        $this->assertInstanceOf(\Mindbox\DTO\LineRequestCollection::class, $field);
    }
    ...
    public function testGetPayments()
    {
        ...
        $this->assertInstanceOf(\Mindbox\DTO\PaymentRequestCollection::class, $field);
    }
