...
use Mindbox\DTO\V2\Responses\CustomerResponseDTO;
...
class CustomerResponseDTOTest extends CustomerIdentityResponseDTOTest
{
    ...
    public function setUp(): void
    {
        $data      = [
            ...
            'status'                 => 'some_status',
            'discountCards'          => ['someField' => 'someValue'],
    ...
    public function testGetArea()
    {
        ...
        $this->assertInstanceOf(\Mindbox\DTO\V2\Responses\AreaResponseDTO::class, $field);
    }
    ...
    public function testGetSubscriptions()
    {
        ...
        $this->assertInstanceOf(\Mindbox\DTO\V2\Responses\SubscriptionResponseCollection::class, $field);
    }
    ...
    {
        $field = $this->dto->getDiscountCards();

        $this->assertInstanceOf(\Mindbox\DTO\V2\Responses\DiscountCardResponseCollection::class, $field);
    }
