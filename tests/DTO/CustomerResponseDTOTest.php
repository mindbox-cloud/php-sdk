...
class CustomerResponseDTOTest extends CustomerIdentityResponseDTOTest
{
    ...
    public function testGetArea()
    {
        ...
        $this->assertInstanceOf(\Mindbox\DTO\AreaResponseDTO::class, $field);
    }
    ...
    public function testGetSubscriptions()
    {
        ...
        $this->assertInstanceOf(\Mindbox\DTO\SubscriptionResponseCollection::class, $field);
    }
    ...
    public function testGetDiscountCards()
    {
        ...
        $this->assertInstanceOf(\Mindbox\DTO\DiscountCardResponseCollection::class, $field);
    }
