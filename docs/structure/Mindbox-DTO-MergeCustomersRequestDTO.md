Mindbox\DTO\MergeCustomersRequestDTO
===============
...
### $customersToMerge
    ...
    public \Mindbox\DTO\CustomerIdentityRequestCollection $customersToMerge
...
### $resultingCustomer
    ...
    public \Mindbox\DTO\CustomerIdentityRequestDTO $resultingCustomer
...
### getCustomersToMerge
    ...
    \Mindbox\DTO\CustomerIdentityRequestCollection Mindbox\DTO\MergeCustomersRequestDTO::getCustomersToMerge()
...
### setCustomersToMerge
    ...
    mixed Mindbox\DTO\MergeCustomersRequestDTO::setCustomersToMerge(array|\Mindbox\DTO\CustomerIdentityRequestCollection $customersToMerge)
...
#### Arguments
* $customersToMerge **array|[array](Mindbox-DTO-CustomerIdentityRequestCollection.md)**



### getResultingCustomer

    \Mindbox\DTO\CustomerIdentityRequestDTO Mindbox\DTO\MergeCustomersRequestDTO::getResultingCustomer()
...
### setResultingCustomer
    ...
    mixed Mindbox\DTO\MergeCustomersRequestDTO::setResultingCustomer(array|\Mindbox\DTO\CustomerIdentityRequestDTO $resultingCustomer)
...
#### Arguments
* $resultingCustomer **array|[array](Mindbox-DTO-CustomerIdentityRequestDTO.md)**
