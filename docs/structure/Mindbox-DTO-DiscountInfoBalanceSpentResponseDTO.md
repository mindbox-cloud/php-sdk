...
* Parent class: [Mindbox\DTO\DiscountInfoBalanceResponseDTO](Mindbox-DTO-DiscountInfoBalanceResponseDTO.md)
...
### getSpentAmountForCurrentOrder
    ...
    string Mindbox\DTO\DiscountInfoBalanceSpentResponseDTO::getSpentAmountForCurrentOrder()
...
### getBalance
    ...
    \Mindbox\DTO\BalanceDiscountResponseDTO Mindbox\DTO\DiscountInfoBalanceResponseDTO::getBalance()
...
* Visibility: **public**
* This method is defined by [Mindbox\DTO\DiscountInfoBalanceResponseDTO](Mindbox-DTO-DiscountInfoBalanceResponseDTO.md)
...
### getType
    ...
    string Mindbox\DTO\DiscountInfoResponseDTO::getType()
...
* Visibility: **public**
* This method is defined by [Mindbox\DTO\DiscountInfoResponseDTO](Mindbox-DTO-DiscountInfoResponseDTO.md)
...
### getAvailableAmountForCurrentOrder
    ...
    string Mindbox\DTO\DiscountInfoResponseDTO::getAvailableAmountForCurrentOrder()
