Mindbox\DTO\V2\Requests\PaymentRequestDTO
===============
...
* Class name: PaymentRequestDTO
* Namespace: Mindbox\DTO\V2\Requests
* Parent class: [Mindbox\DTO\V2\PaymentDTO](Mindbox-DTO-V2-PaymentDTO.md)
...
* Visibility: **public**
* This property is defined by [Mindbox\DTO\V2\PaymentDTO](Mindbox-DTO-V2-PaymentDTO.md)
...
### setType
    ...
    mixed Mindbox\DTO\V2\Requests\PaymentRequestDTO::setType(mixed $type)
...
### setId
    ...
    mixed Mindbox\DTO\V2\Requests\PaymentRequestDTO::setId(mixed $id)
...
### setAmount
    ...
    mixed Mindbox\DTO\V2\Requests\PaymentRequestDTO::setAmount(mixed $amount)
...
### getType
    ...
    string Mindbox\DTO\V2\PaymentDTO::getType()
...
* Visibility: **public**
* This method is defined by [Mindbox\DTO\V2\PaymentDTO](Mindbox-DTO-V2-PaymentDTO.md)
...
### getId
    ...
    string Mindbox\DTO\V2\PaymentDTO::getId()
...
### getAmount
    ...
    string Mindbox\DTO\V2\PaymentDTO::getAmount()
