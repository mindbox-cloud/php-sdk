Mindbox\DTO\V3\Responses\ActionTemplateResponseDTO
===============
...
* Class name: ActionTemplateResponseDTO
...
### getSystemName
    ...
    string Mindbox\DTO\V3\Responses\ActionTemplateResponseDTO::getSystemName()
...
### getName
    ...
    string Mindbox\DTO\V3\Responses\ActionTemplateResponseDTO::getName()
