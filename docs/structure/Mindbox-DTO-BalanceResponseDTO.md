...
### getTotalValue
    ...
    string Mindbox\DTO\BalanceResponseDTO::getTotalValue()
...
### getAvailableValue
    ...
    string Mindbox\DTO\BalanceResponseDTO::getAvailableValue()
...
### getBlockedValue
    ...
    string Mindbox\DTO\BalanceResponseDTO::getBlockedValue()
