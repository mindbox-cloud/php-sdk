Mindbox\DTO\V2\Requests\AreaRequestDTO
===============
...
* Class name: AreaRequestDTO
* Namespace: Mindbox\DTO\V2\Requests
* Parent class: [Mindbox\DTO\V2\AreaDTO](Mindbox-DTO-V2-AreaDTO.md)
...
* Visibility: **public**
* This property is defined by [Mindbox\DTO\V2\AreaDTO](Mindbox-DTO-V2-AreaDTO.md)
...
### setName
    ...
    mixed Mindbox\DTO\V2\Requests\AreaRequestDTO::setName(mixed $name)
...
### setId
    ...
    mixed Mindbox\DTO\V2\Requests\AreaRequestDTO::setId(string $name, mixed $value)
...
### setIds
    ...
    mixed Mindbox\DTO\V2\Requests\AreaRequestDTO::setIds(array $ids)
...
### getName
    ...
    string Mindbox\DTO\V2\AreaDTO::getName()
...
* Visibility: **public**
* This method is defined by [Mindbox\DTO\V2\AreaDTO](Mindbox-DTO-V2-AreaDTO.md)
...
### getId
    ...
    string|null Mindbox\DTO\V2\AreaDTO::getId(string $name)
...
### getIds
    ...
    mixed Mindbox\DTO\V2\AreaDTO::getIds()
