...
### getChangeAmount
    ...
    string Mindbox\DTO\CustomerBalanceChangeResponseDTO::getChangeAmount()
...
### getExpirationDateTimeUtc
    ...
    string Mindbox\DTO\CustomerBalanceChangeResponseDTO::getExpirationDateTimeUtc()
...
### getIsAvailable
    ...
    string Mindbox\DTO\CustomerBalanceChangeResponseDTO::getIsAvailable()
...
### getBalanceChangeKind
    ...
    \Mindbox\DTO\BalanceChangeKindResponseDTO Mindbox\DTO\CustomerBalanceChangeResponseDTO::getBalanceChangeKind()
