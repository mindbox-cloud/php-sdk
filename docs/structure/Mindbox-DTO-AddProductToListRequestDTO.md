...
### getProduct
    ...
    \Mindbox\DTO\ProductRequestDTO Mindbox\DTO\AddProductToListRequestDTO::getProduct()
...
### setProduct
    ...
    mixed Mindbox\DTO\AddProductToListRequestDTO::setProduct(array|\Mindbox\DTO\ProductRequestDTO $product)
