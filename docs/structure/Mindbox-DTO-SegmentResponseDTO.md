Mindbox\DTO\SegmentResponseDTO
===============
...
### getName
    ...
    string Mindbox\DTO\SegmentResponseDTO::getName()
...
### getId
    ...
    string|null Mindbox\DTO\SegmentResponseDTO::getId(string $name)
...
### getIds
    ...
    mixed Mindbox\DTO\SegmentResponseDTO::getIds()
