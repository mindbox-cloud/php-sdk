Mindbox\DTO\DiscountBalanceRequestDTO
===============
...
* Parent class: [Mindbox\DTO\DiscountRequestDTO](Mindbox-DTO-DiscountRequestDTO.md)
...
### $balanceType
    ...
    public \Mindbox\DTO\BalanceTypeRequestDTO $balanceType
...
### getBalanceType
    ...
    \Mindbox\DTO\BalanceTypeRequestDTO Mindbox\DTO\DiscountBalanceRequestDTO::getBalanceType()
...
### setBalanceType
    ...
    mixed Mindbox\DTO\DiscountBalanceRequestDTO::setBalanceType(array|\Mindbox\DTO\BalanceTypeRequestDTO $balanceType)
...
#### Arguments
* $balanceType **array|[array](Mindbox-DTO-BalanceTypeRequestDTO.md)**



### setType

    mixed Mindbox\DTO\DiscountRequestDTO::setType(mixed $type)
...
* Visibility: **public**
* This method is defined by [Mindbox\DTO\DiscountRequestDTO](Mindbox-DTO-DiscountRequestDTO.md)
...
### setAmount
    ...
    mixed Mindbox\DTO\DiscountRequestDTO::setAmount(mixed $amount)
...
### setId
    ...
    mixed Mindbox\DTO\DiscountRequestDTO::setId(mixed $id)
...
### getType
    ...
    string Mindbox\DTO\DiscountDTO::getType()
...
* Visibility: **public**
* This method is defined by [Mindbox\DTO\DiscountDTO](Mindbox-DTO-DiscountDTO.md)
...
### getAmount
    ...
    string Mindbox\DTO\DiscountDTO::getAmount()
...
### getId
    ...
    string Mindbox\DTO\DiscountDTO::getId()
