Mindbox\DTO\V2\Responses\CustomerIdentityResponseDTO
===============
...
* Class name: CustomerIdentityResponseDTO
* Namespace: Mindbox\DTO\V2\Responses
* Parent class: [Mindbox\DTO\V2\CustomerIdentityDTO](Mindbox-DTO-V2-CustomerIdentityDTO.md)
