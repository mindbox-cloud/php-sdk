Mindbox\DTO\V3\Responses\CustomerBalanceChangeResponseDTO
===============
...
* Class name: CustomerBalanceChangeResponseDTO
...
### $balanceChangeKind
    ...
    public \Mindbox\DTO\V3\Responses\BalanceChangeKindResponseDTO $balanceChangeKind
...
### getChangeAmount
    ...
    string Mindbox\DTO\V3\Responses\CustomerBalanceChangeResponseDTO::getChangeAmount()
...
### getExpirationDateTimeUtc
    ...
    string Mindbox\DTO\V3\Responses\CustomerBalanceChangeResponseDTO::getExpirationDateTimeUtc()
...
### getIsAvailable
    ...
    string Mindbox\DTO\V3\Responses\CustomerBalanceChangeResponseDTO::getIsAvailable()
...
### getBalanceChangeKind

    \Mindbox\DTO\V3\Responses\BalanceChangeKindResponseDTO Mindbox\DTO\V3\Responses\CustomerBalanceChangeResponseDTO::getBalanceChangeKind()
