Mindbox\DTO\V3\Requests\SetProductListRequestDTO
===============
...
* Class name: SetProductListRequestDTO
...
### $products
    ...
    public \Mindbox\DTO\V3\Requests\ProductListItemRequestCollection $products
...
### getProducts
    ...
    \Mindbox\DTO\V3\Requests\ProductListItemRequestCollection Mindbox\DTO\V3\Requests\SetProductListRequestDTO::getProducts()
...
### setProducts
    ...
    mixed Mindbox\DTO\V3\Requests\SetProductListRequestDTO::setProducts(array|\Mindbox\DTO\V3\Requests\ProductListItemRequestCollection $products)
...
#### Arguments
* $products **array|[array](Mindbox-DTO-V3-Requests-ProductListItemRequestCollection.md)**
