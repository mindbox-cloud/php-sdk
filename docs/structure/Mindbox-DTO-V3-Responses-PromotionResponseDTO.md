Mindbox\DTO\V3\Responses\PromotionResponseDTO
===============
...
* Class name: PromotionResponseDTO
...
### getName
    ...
    string Mindbox\DTO\V3\Responses\PromotionResponseDTO::getName()
...
### getType
    ...
    string Mindbox\DTO\V3\Responses\PromotionResponseDTO::getType()
...
### getId
    ...
    string|null Mindbox\DTO\V3\Responses\PromotionResponseDTO::getId(string $name)
...
### getIds
    ...
    mixed Mindbox\DTO\V3\Responses\PromotionResponseDTO::getIds()
