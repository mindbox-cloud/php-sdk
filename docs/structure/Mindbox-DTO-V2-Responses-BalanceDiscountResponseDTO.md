Mindbox\DTO\V2\Responses\BalanceDiscountResponseDTO
===============
...
* Class name: BalanceDiscountResponseDTO
...
### getBalanceType
    ...
    \Mindbox\DTO\V2\Responses\BalanceTypeResponseDTO Mindbox\DTO\V2\Responses\BalanceDiscountResponseDTO::getBalanceType()
...
### getTotal
    ...
    string Mindbox\DTO\V2\Responses\BalanceDiscountResponseDTO::getTotal()
...
### getAvailable
    ...
    string Mindbox\DTO\V2\Responses\BalanceDiscountResponseDTO::getAvailable()
...
### getBlocked
    ...
    string Mindbox\DTO\V2\Responses\BalanceDiscountResponseDTO::getBlocked()
