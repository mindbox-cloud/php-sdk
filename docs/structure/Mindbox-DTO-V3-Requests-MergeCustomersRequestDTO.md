Mindbox\DTO\V3\Requests\MergeCustomersRequestDTO
===============
...
* Class name: MergeCustomersRequestDTO
...
### $customersToMerge
    ...
    public \Mindbox\DTO\V3\Requests\CustomerIdentityRequestCollection $customersToMerge
...
### $resultingCustomer
    ...
    public \Mindbox\DTO\V3\Requests\CustomerIdentityRequestDTO $resultingCustomer
...
### getCustomersToMerge
    ...
    \Mindbox\DTO\V3\Requests\CustomerIdentityRequestCollection Mindbox\DTO\V3\Requests\MergeCustomersRequestDTO::getCustomersToMerge()
...
### setCustomersToMerge
    ...
    mixed Mindbox\DTO\V3\Requests\MergeCustomersRequestDTO::setCustomersToMerge(array|\Mindbox\DTO\V3\Requests\CustomerIdentityRequestCollection $customersToMerge)
...
#### Arguments
* $customersToMerge **array|[array](Mindbox-DTO-V3-Requests-CustomerIdentityRequestCollection.md)**



### getResultingCustomer

    \Mindbox\DTO\V3\Requests\CustomerIdentityRequestDTO Mindbox\DTO\V3\Requests\MergeCustomersRequestDTO::getResultingCustomer()
...
### setResultingCustomer

    mixed Mindbox\DTO\V3\Requests\MergeCustomersRequestDTO::setResultingCustomer(array|\Mindbox\DTO\V3\Requests\CustomerIdentityRequestDTO $resultingCustomer)
...
#### Arguments
* $resultingCustomer **array|[array](Mindbox-DTO-V3-Requests-CustomerIdentityRequestDTO.md)**
