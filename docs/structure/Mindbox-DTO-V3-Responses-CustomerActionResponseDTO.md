Mindbox\DTO\V3\Responses\CustomerActionResponseDTO
===============
...
* Class name: CustomerActionResponseDTO
...
### $actionTemplate
    ...
    public \Mindbox\DTO\V3\Responses\ActionTemplateResponseDTO $actionTemplate
...
### $pointOfContact
    ...
    public \Mindbox\DTO\V3\Responses\PointOfContactResponseDTO $pointOfContact
...
### $customerBalanceChanges
    ...
    public \Mindbox\DTO\V3\Responses\CustomerBalanceChangeResponseCollection $customerBalanceChanges
...
### $order
    ...
    public \Mindbox\DTO\V3\Responses\OrderResponseDTO $order
...
### getActionTemplate
    ...
    \Mindbox\DTO\V3\Responses\ActionTemplateResponseDTO Mindbox\DTO\V3\Responses\CustomerActionResponseDTO::getActionTemplate()
...
### getDateTimeUtc
    ...
    string Mindbox\DTO\V3\Responses\CustomerActionResponseDTO::getDateTimeUtc()
...
### getPointOfContact
    ...
    \Mindbox\DTO\V3\Responses\PointOfContactResponseDTO Mindbox\DTO\V3\Responses\CustomerActionResponseDTO::getPointOfContact()
...
### getCustomer
    ...
    \Mindbox\DTO\V3\Responses\CustomerResponseDTO Mindbox\DTO\V3\Responses\CustomerActionResponseDTO::getCustomer()
...
### getCustomerBalanceChanges

    \Mindbox\DTO\V3\Responses\CustomerBalanceChangeResponseCollection Mindbox\DTO\V3\Responses\CustomerActionResponseDTO::getCustomerBalanceChanges()
...
### getOrder
    ...
    \Mindbox\DTO\V3\Responses\OrderResponseDTO Mindbox\DTO\V3\Responses\CustomerActionResponseDTO::getOrder()
...
### getId
    ...
    string|null Mindbox\DTO\V3\Responses\CustomerActionResponseDTO::getId(string $name)
...
### getIds
    ...
    mixed Mindbox\DTO\V3\Responses\CustomerActionResponseDTO::getIds()
