Mindbox\DTO\DiscountInfoPromoCodeResponseDTO
===============
...
* Parent class: [Mindbox\DTO\DiscountInfoResponseDTO](Mindbox-DTO-DiscountInfoResponseDTO.md)
...
### $promoCode
    ...
    public \Mindbox\DTO\PromoCodeResponseDTO $promoCode
...
### getPromoCode
    ...
    \Mindbox\DTO\PromoCodeResponseDTO Mindbox\DTO\DiscountInfoPromoCodeResponseDTO::getPromoCode()
