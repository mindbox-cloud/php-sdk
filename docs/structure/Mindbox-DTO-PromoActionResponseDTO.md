Mindbox\DTO\PromoActionResponseDTO
===============
...
### getName
    ...
    string Mindbox\DTO\PromoActionResponseDTO::getName()
...
### getId
    ...
    string|null Mindbox\DTO\PromoActionResponseDTO::getId(string $name)
...
### getIds
    ...
    mixed Mindbox\DTO\PromoActionResponseDTO::getIds()
