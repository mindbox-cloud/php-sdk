Mindbox\DTO\V3\Responses\DiscountCardResponseDTO
===============
...
* Class name: DiscountCardResponseDTO
...
### $type
    ...
    public \Mindbox\DTO\V3\Responses\DiscountCardTypeResponseDTO $type
...
### $status
    ...
    public \Mindbox\DTO\V3\Responses\DiscountCardStatusResponseDTO $status
...
### getType
    ...
    \Mindbox\DTO\V3\Responses\DiscountCardTypeResponseDTO Mindbox\DTO\V3\Responses\DiscountCardResponseDTO::getType()
...
### getStatus
    ...
    string Mindbox\DTO\V3\Responses\DiscountCardResponseDTO::getStatus()
...
### getId
    ...
    string|null Mindbox\DTO\V3\Responses\DiscountCardResponseDTO::getId(string $name)
...
### getIds
    ...
    mixed Mindbox\DTO\V3\Responses\DiscountCardResponseDTO::getIds()
