Mindbox\DTO\V3\Requests\DiscountCardIdentityRequestDTO
===============
...
* Class name: DiscountCardIdentityRequestDTO
...
### setId
    ...
    mixed Mindbox\DTO\V3\Requests\DiscountCardIdentityRequestDTO::setId(string $name, mixed $value)
...
### setIds
    ...
    mixed Mindbox\DTO\V3\Requests\DiscountCardIdentityRequestDTO::setIds(array $ids)
