Mindbox\DTO\V2\Responses\PromoCodeResponseDTO
===============
...
* Class name: PromoCodeResponseDTO
...
### $type
    ...
    public \Mindbox\DTO\V2\Responses\PromoCodeTypeResponseDTO $type
...
### $availableFromDateTimeUtc
    ...
    public string $availableFromDateTimeUtc
...
### $availableTillDateTimeUtc
    ...
    public string $availableTillDateTimeUtc
...
### getId
    ...
    string Mindbox\DTO\V2\Responses\PromoCodeResponseDTO::getId()
...
### getStatus
    ...
    string Mindbox\DTO\V2\Responses\PromoCodeResponseDTO::getStatus()
...
### getType
    ...
    \Mindbox\DTO\V2\Responses\PromoCodeTypeResponseDTO Mindbox\DTO\V2\Responses\PromoCodeResponseDTO::getType()
...
### getAvailableFromDateTimeUtc

    string Mindbox\DTO\V2\Responses\PromoCodeResponseDTO::getAvailableFromDateTimeUtc()
...
### getAvailableTillDateTimeUtc

    string Mindbox\DTO\V2\Responses\PromoCodeResponseDTO::getAvailableTillDateTimeUtc()
...
### getUsedDateTimeUtc
    ...
    string Mindbox\DTO\V2\Responses\PromoCodeResponseDTO::getUsedDateTimeUtc()
