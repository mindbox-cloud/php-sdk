Mindbox\DTO\V3\Responses\DiscountCardStatusResponseDTO
===============
...
* Class name: DiscountCardStatusResponseDTO
...
### getDateTimeUtc
    ...
    string Mindbox\DTO\V3\Responses\DiscountCardStatusResponseDTO::getDateTimeUtc()
...
### getId
    ...
    string|null Mindbox\DTO\V3\Responses\DiscountCardStatusResponseDTO::getId(string $name)
...
### getIds
    ...
    mixed Mindbox\DTO\V3\Responses\DiscountCardStatusResponseDTO::getIds()
