Mindbox\DTO\V2\Requests\DiscountCardIdentityRequestDTO
===============
...
### setId
    ...
    mixed Mindbox\DTO\V2\Requests\DiscountCardIdentityRequestDTO::setId(string $name, mixed $value)
...
### setIds
    ...
    mixed Mindbox\DTO\V2\Requests\DiscountCardIdentityRequestDTO::setIds(array $ids)
