Mindbox\DTO\V2\Responses\BalanceGiftCardResponseDTO
===============
...
* Class name: BalanceGiftCardResponseDTO
...
### getTotal
    ...
    string Mindbox\DTO\V2\Responses\BalanceGiftCardResponseDTO::getTotal()
...
### getAvailable
    ...
    string Mindbox\DTO\V2\Responses\BalanceGiftCardResponseDTO::getAvailable()
...
### getUsed
    ...
    string Mindbox\DTO\V2\Responses\BalanceGiftCardResponseDTO::getUsed()
