Mindbox\DTO\V2\Requests\BalanceTypeRequestDTO
===============
...
* Class name: BalanceTypeRequestDTO
* Namespace: Mindbox\DTO\V2\Requests
* Parent class: [Mindbox\DTO\V2\BalanceTypeDTO](Mindbox-DTO-V2-BalanceTypeDTO.md)
...
* Visibility: **public**
* This property is defined by [Mindbox\DTO\V2\BalanceTypeDTO](Mindbox-DTO-V2-BalanceTypeDTO.md)
...
### setId
    ...
    mixed Mindbox\DTO\V2\Requests\BalanceTypeRequestDTO::setId(string $name, mixed $value)
...
### setIds
    ...
    mixed Mindbox\DTO\V2\Requests\BalanceTypeRequestDTO::setIds(array $ids)
...
### getId
    ...
    string|null Mindbox\DTO\V2\BalanceTypeDTO::getId(string $name)
...
* Visibility: **public**
* This method is defined by [Mindbox\DTO\V2\BalanceTypeDTO](Mindbox-DTO-V2-BalanceTypeDTO.md)
...
### getIds
    ...
    mixed Mindbox\DTO\V2\BalanceTypeDTO::getIds()
