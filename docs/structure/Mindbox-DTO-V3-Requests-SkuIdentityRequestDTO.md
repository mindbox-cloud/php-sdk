Mindbox\DTO\V3\Requests\SkuIdentityRequestDTO
===============
...
* Class name: SkuIdentityRequestDTO
* Namespace: Mindbox\DTO\V3\Requests
* Parent class: [Mindbox\DTO\V3\SkuIdentityDTO](Mindbox-DTO-V3-SkuIdentityDTO.md)
