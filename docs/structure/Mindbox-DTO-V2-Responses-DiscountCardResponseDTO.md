Mindbox\DTO\V2\Responses\DiscountCardResponseDTO
===============
...
### $type
    ...
    public \Mindbox\DTO\V2\Responses\DiscountCardTypeResponseDTO $type
...
### getType
    ...
    \Mindbox\DTO\V2\Responses\DiscountCardTypeResponseDTO Mindbox\DTO\V2\Responses\DiscountCardResponseDTO::getType()
...
### getStatus
    ...
    string Mindbox\DTO\V2\Responses\DiscountCardResponseDTO::getStatus()
...
### getId
    ...
    string|null Mindbox\DTO\V2\Responses\DiscountCardResponseDTO::getId(string $name)
...
### getIds
    ...
    mixed Mindbox\DTO\V2\Responses\DiscountCardResponseDTO::getIds()
