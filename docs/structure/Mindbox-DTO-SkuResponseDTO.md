...
* Parent class: [Mindbox\DTO\SkuIdentityResponseDTO](Mindbox-DTO-SkuIdentityResponseDTO.md)
...
### getProductId
    ...
    string Mindbox\DTO\SkuResponseDTO::getProductId()
...
### getBasePricePerItem
    ...
    string Mindbox\DTO\SkuResponseDTO::getBasePricePerItem()
...
### getSkuId
    ...
    string Mindbox\DTO\SkuResponseDTO::getSkuId()
