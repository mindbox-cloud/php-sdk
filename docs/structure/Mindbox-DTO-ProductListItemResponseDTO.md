Mindbox\DTO\ProductListItemResponseDTO
===============
...
* Class name: ProductListItemResponseDTO
...
### getProduct
    ...
    \Mindbox\DTO\ProductResponseDTO Mindbox\DTO\ProductListItemResponseDTO::getProduct()
