Mindbox\DTO\V3\Requests\SmsConfirmationRequestDTO
===============
...
* Class name: SmsConfirmationRequestDTO
...
### getCode
    ...
    string Mindbox\DTO\V3\Requests\SmsConfirmationRequestDTO::getCode()
...
### setCode
    ...
    mixed Mindbox\DTO\V3\Requests\SmsConfirmationRequestDTO::setCode(mixed $code)
