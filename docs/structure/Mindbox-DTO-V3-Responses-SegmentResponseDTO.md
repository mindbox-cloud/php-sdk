Mindbox\DTO\V3\Responses\SegmentResponseDTO
===============
...
### getName
    ...
    string Mindbox\DTO\V3\Responses\SegmentResponseDTO::getName()
...
### getId
    ...
    string|null Mindbox\DTO\V3\Responses\SegmentResponseDTO::getId(string $name)
...
### getIds
    ...
    mixed Mindbox\DTO\V3\Responses\SegmentResponseDTO::getIds()
