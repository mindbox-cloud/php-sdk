Mindbox\DTO\ProductIdentityRequestDTO
===============
...
* Class name: ProductIdentityRequestDTO
* Namespace: Mindbox\DTO
* Parent class: [Mindbox\DTO\ProductIdentityDTO](Mindbox-DTO-ProductIdentityDTO.md)
...
### setId
    ...
    mixed Mindbox\DTO\ProductIdentityRequestDTO::setId($name, $value)
