Mindbox\DTO\SmsConfirmationRequestDTO
===============
...
### getCode
    ...
    string Mindbox\DTO\SmsConfirmationRequestDTO::getCode()
...
### setCode
    ...
    mixed Mindbox\DTO\SmsConfirmationRequestDTO::setCode(mixed $code)
