Mindbox\DTO\V3\Responses\AppliedPromotionResponseDTO
===============
...
* Class name: AppliedPromotionResponseDTO
...
### $coupon
    ...
    public \Mindbox\DTO\V3\Responses\CouponResponseDTO $coupon
...
### $promotion
    ...
    public \Mindbox\DTO\V3\Responses\PromotionResponseDTO $promotion
...
### $issuedCoupon
    ...
    public \Mindbox\DTO\V3\Responses\IssuedCouponResponseDTO $issuedCoupon
...
### getType
    ...
    string Mindbox\DTO\V3\Responses\AppliedPromotionResponseDTO::getType()
...
### getCoupon
    ...
    \Mindbox\DTO\V3\Responses\CouponResponseDTO Mindbox\DTO\V3\Responses\AppliedPromotionResponseDTO::getCoupon()
...
### getPromotion
    ...
    \Mindbox\DTO\V3\Responses\PromotionResponseDTO Mindbox\DTO\V3\Responses\AppliedPromotionResponseDTO::getPromotion()
...
### getBalanceType
    ...
    \Mindbox\DTO\V3\Responses\BalanceTypeResponseDTO Mindbox\DTO\V3\Responses\AppliedPromotionResponseDTO::getBalanceType()
...
### getAmount
    ...
    string Mindbox\DTO\V3\Responses\AppliedPromotionResponseDTO::getAmount()
...
### getExpirationDateTimeUtc
    ...
    string Mindbox\DTO\V3\Responses\AppliedPromotionResponseDTO::getExpirationDateTimeUtc()
...
### getIssuedCoupon
    ...
    \Mindbox\DTO\V3\Responses\IssuedCouponResponseDTO Mindbox\DTO\V3\Responses\AppliedPromotionResponseDTO::getIssuedCoupon()
