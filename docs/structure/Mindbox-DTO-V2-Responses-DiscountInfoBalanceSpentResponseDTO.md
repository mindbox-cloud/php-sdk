Mindbox\DTO\V2\Responses\DiscountInfoBalanceSpentResponseDTO
===============
...
* Class name: DiscountInfoBalanceSpentResponseDTO
* Namespace: Mindbox\DTO\V2\Responses
* Parent class: [Mindbox\DTO\V2\Responses\DiscountInfoBalanceResponseDTO](Mindbox-DTO-V2-Responses-DiscountInfoBalanceResponseDTO.md)
...
### $balance
    ...
    public \Mindbox\DTO\V2\Responses\BalanceDiscountResponseDTO $balance
...
* Visibility: **public**
* This property is defined by [Mindbox\DTO\V2\Responses\DiscountInfoBalanceResponseDTO](Mindbox-DTO-V2-Responses-DiscountInfoBalanceResponseDTO.md)
...
* Visibility: **public**
* This property is defined by [Mindbox\DTO\V2\Responses\DiscountInfoResponseDTO](Mindbox-DTO-V2-Responses-DiscountInfoResponseDTO.md)
...
### getSpentAmountForCurrentOrder

    string Mindbox\DTO\V2\Responses\DiscountInfoBalanceSpentResponseDTO::getSpentAmountForCurrentOrder()
...
### getBalance
    ...
    \Mindbox\DTO\V2\Responses\BalanceDiscountResponseDTO Mindbox\DTO\V2\Responses\DiscountInfoBalanceResponseDTO::getBalance()
...
* Visibility: **public**
* This method is defined by [Mindbox\DTO\V2\Responses\DiscountInfoBalanceResponseDTO](Mindbox-DTO-V2-Responses-DiscountInfoBalanceResponseDTO.md)
...
### getType
    ...
    string Mindbox\DTO\V2\Responses\DiscountInfoResponseDTO::getType()
...
* Visibility: **public**
* This method is defined by [Mindbox\DTO\V2\Responses\DiscountInfoResponseDTO](Mindbox-DTO-V2-Responses-DiscountInfoResponseDTO.md)




### getAvailableAmountForCurrentOrder

    string Mindbox\DTO\V2\Responses\DiscountInfoResponseDTO::getAvailableAmountForCurrentOrder()
