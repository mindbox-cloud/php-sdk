Mindbox\DTO\V3\Responses\SmsConfirmationResponseDTO
===============
...
* Class name: SmsConfirmationResponseDTO
...
### getProcessingStatus
    ...
    string Mindbox\DTO\V3\Responses\SmsConfirmationResponseDTO::getProcessingStatus()
