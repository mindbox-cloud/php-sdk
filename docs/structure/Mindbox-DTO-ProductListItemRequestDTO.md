Mindbox\DTO\ProductListItemRequestDTO
===============
...
* Parent class: [Mindbox\DTO\ProductListItemDTO](Mindbox-DTO-ProductListItemDTO.md)
...
### getProduct
    ...
    \Mindbox\DTO\ProductRequestDTO Mindbox\DTO\ProductListItemRequestDTO::getProduct()
...
### setProduct
    ...
    mixed Mindbox\DTO\ProductListItemRequestDTO::setProduct(\Mindbox\DTO\ProductRequestDTO|array $product)
...
#### Arguments
* $product **[Mindbox\DTO\ProductRequestDTO](Mindbox-DTO-ProductRequestDTO.md)|array**



### setCount

    mixed Mindbox\DTO\ProductListItemRequestDTO::setCount(mixed $count)
...
### setPrice
    ...
    mixed Mindbox\DTO\ProductListItemRequestDTO::setPrice(mixed $price)
...
### getCount
    ...
    string Mindbox\DTO\ProductListItemDTO::getCount()
...
* Visibility: **public**
* This method is defined by [Mindbox\DTO\ProductListItemDTO](Mindbox-DTO-ProductListItemDTO.md)
...
### getPrice
    ...
    string Mindbox\DTO\ProductListItemDTO::getPrice()
