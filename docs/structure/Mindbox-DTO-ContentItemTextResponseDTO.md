Mindbox\DTO\ContentItemTextResponseDTO
===============
...
* Parent class: [Mindbox\DTO\ContentItemResponseDTO](Mindbox-DTO-ContentItemResponseDTO.md)
...
### getType
    ...
    string Mindbox\DTO\ContentItemResponseDTO::getType()
...
* Visibility: **public**
* This method is defined by [Mindbox\DTO\ContentItemResponseDTO](Mindbox-DTO-ContentItemResponseDTO.md)
...
### getPromoActionId
    ...
    string Mindbox\DTO\ContentItemResponseDTO::getPromoActionId()
