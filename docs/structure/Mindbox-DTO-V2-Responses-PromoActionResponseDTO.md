Mindbox\DTO\V2\Responses\PromoActionResponseDTO
===============
...
* Class name: PromoActionResponseDTO
...
### getName
    ...
    string Mindbox\DTO\V2\Responses\PromoActionResponseDTO::getName()
...
### getId
    ...
    string|null Mindbox\DTO\V2\Responses\PromoActionResponseDTO::getId(string $name)
...
### getIds
    ...
    mixed Mindbox\DTO\V2\Responses\PromoActionResponseDTO::getIds()
