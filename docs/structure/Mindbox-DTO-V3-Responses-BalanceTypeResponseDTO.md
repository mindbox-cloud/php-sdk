Mindbox\DTO\V3\Responses\BalanceTypeResponseDTO
===============
...
### getName
    ...
    string Mindbox\DTO\V3\Responses\BalanceTypeResponseDTO::getName()
...
### getId
    ...
    string|null Mindbox\DTO\V3\Responses\BalanceTypeResponseDTO::getId(string $name)
...
### getIds
    ...
    mixed Mindbox\DTO\V3\Responses\BalanceTypeResponseDTO::getIds()
