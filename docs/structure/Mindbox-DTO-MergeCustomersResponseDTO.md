...
* Class name: MergeCustomersResponseDTO
...
### getCustomersToMerge
    ...
    \Mindbox\DTO\CustomerIdentityResponseCollection Mindbox\DTO\MergeCustomersResponseDTO::getCustomersToMerge()
...
### getResultingCustomer
    ...
    \Mindbox\DTO\CustomerIdentityResponseDTO Mindbox\DTO\MergeCustomersResponseDTO::getResultingCustomer()
