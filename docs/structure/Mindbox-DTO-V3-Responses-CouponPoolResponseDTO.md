Mindbox\DTO\V3\Responses\CouponPoolResponseDTO
===============
...
* Class name: CouponPoolResponseDTO
...
### getName
    ...
    string Mindbox\DTO\V3\Responses\CouponPoolResponseDTO::getName()
...
### getDescription
    ...
    string Mindbox\DTO\V3\Responses\CouponPoolResponseDTO::getDescription()
...
### getId
    ...
    string|null Mindbox\DTO\V3\Responses\CouponPoolResponseDTO::getId(string $name)
...
### getIds
    ...
    mixed Mindbox\DTO\V3\Responses\CouponPoolResponseDTO::getIds()
