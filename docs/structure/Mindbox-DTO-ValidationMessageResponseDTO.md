Mindbox\DTO\ValidationMessageResponseDTO
===============
...
### getMessage
    ...
    string Mindbox\DTO\ValidationMessageResponseDTO::getMessage()
...
### getLocation
    ...
    string Mindbox\DTO\ValidationMessageResponseDTO::getLocation()
