Mindbox\DTO\V3\Responses\PointOfContactResponseDTO
===============
...
* Class name: PointOfContactResponseDTO
...
### getId
    ...
    string|null Mindbox\DTO\V3\Responses\PointOfContactResponseDTO::getId(string $name)
...
### getIds
    ...
    mixed Mindbox\DTO\V3\Responses\PointOfContactResponseDTO::getIds()
