Mindbox\DTO\PromoCodeResponseDTO
===============
...
### $type
    ...
    public \Mindbox\DTO\PromoCodeTypeResponseDTO $type
...
### getId
    ...
    string Mindbox\DTO\PromoCodeResponseDTO::getId()
...
### getStatus
    ...
    string Mindbox\DTO\PromoCodeResponseDTO::getStatus()
...
### getType
    ...
    \Mindbox\DTO\PromoCodeTypeResponseDTO Mindbox\DTO\PromoCodeResponseDTO::getType()
...
### getAvailableFromDateTimeUtc
    ...
    string Mindbox\DTO\PromoCodeResponseDTO::getAvailableFromDateTimeUtc()
...
### getAvailableTillDateTimeUtc
    ...
    string Mindbox\DTO\PromoCodeResponseDTO::getAvailableTillDateTimeUtc()
...
### getUsedDateTimeUtc
    ...
    string Mindbox\DTO\PromoCodeResponseDTO::getUsedDateTimeUtc()
