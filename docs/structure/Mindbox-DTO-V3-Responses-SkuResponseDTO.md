Mindbox\DTO\V3\Responses\SkuResponseDTO
===============
...
* Class name: SkuResponseDTO
* Namespace: Mindbox\DTO\V3\Responses
* Parent class: [Mindbox\DTO\V3\Responses\SkuIdentityResponseDTO](Mindbox-DTO-V3-Responses-SkuIdentityResponseDTO.md)
...
### getProductId
    ...
    string Mindbox\DTO\V3\Responses\SkuResponseDTO::getProductId()
...
### getBasePricePerItem
    ...
    string Mindbox\DTO\V3\Responses\SkuResponseDTO::getBasePricePerItem()
...
### getSkuId
    ...
    string Mindbox\DTO\V3\Responses\SkuResponseDTO::getSkuId()
