...
### getSinceDateTimeUtc
    ...
    string Mindbox\DTO\PageRequestDTO::getSinceDateTimeUtc()
...
### setSinceDateTimeUtc
    ...
    mixed Mindbox\DTO\PageRequestDTO::setSinceDateTimeUtc(mixed $sinceDateTimeUtc)
...
### getTillDateTimeUtc
    ...
    string Mindbox\DTO\PageRequestDTO::getTillDateTimeUtc()
...
### setTillDateTimeUtc
    ...
    mixed Mindbox\DTO\PageRequestDTO::setTillDateTimeUtc(mixed $tillDateTimeUtc)
...
### getPageNumber
    ...
    string Mindbox\DTO\PageRequestDTO::getPageNumber()
...
### setPageNumber
    ...
    mixed Mindbox\DTO\PageRequestDTO::setPageNumber(mixed $pageNumber)
...
### getItemsPerPage
    ...
    string Mindbox\DTO\PageRequestDTO::getItemsPerPage()
...
### setItemsPerPage
    ...
    mixed Mindbox\DTO\PageRequestDTO::setItemsPerPage(mixed $itemsPerPage)
