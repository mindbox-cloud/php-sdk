Mindbox\DTO\V3\Requests\SetProductCountInListRequestDTO
===============
...
### $product
    ...
    public \Mindbox\DTO\V3\Requests\ProductRequestDTO $product
...
### getProduct
    ...
    \Mindbox\DTO\V3\Requests\ProductRequestDTO Mindbox\DTO\V3\Requests\SetProductCountInListRequestDTO::getProduct()
...
### setProduct
    ...
    mixed Mindbox\DTO\V3\Requests\SetProductCountInListRequestDTO::setProduct(array|\Mindbox\DTO\V3\Requests\ProductRequestDTO $product)
...
#### Arguments
* $product **array|[array](Mindbox-DTO-V3-Requests-ProductRequestDTO.md)**



### getCount

    string Mindbox\DTO\V3\Requests\SetProductCountInListRequestDTO::getCount()
...
### setCount
    ...
    mixed Mindbox\DTO\V3\Requests\SetProductCountInListRequestDTO::setCount(mixed $count)
