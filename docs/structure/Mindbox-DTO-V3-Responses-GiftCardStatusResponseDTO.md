Mindbox\DTO\V3\Responses\GiftCardStatusResponseDTO
===============
...
* Class name: GiftCardStatusResponseDTO
...
### getId
    ...
    string|null Mindbox\DTO\V3\Responses\GiftCardStatusResponseDTO::getId(string $name)
...
### getIds
    ...
    mixed Mindbox\DTO\V3\Responses\GiftCardStatusResponseDTO::getIds()
