Mindbox\DTO\V3\Responses\LineStatusResponseDTO
===============
...
* Class name: LineStatusResponseDTO
...
### getId
    ...
    string|null Mindbox\DTO\V3\Responses\LineStatusResponseDTO::getId(string $name)
...
### getIds
    ...
    mixed Mindbox\DTO\V3\Responses\LineStatusResponseDTO::getIds()
