Mindbox\DTO\V2\Responses\PossibleDiscountsValueDiscountResponseDTO
===============
...
* Class name: PossibleDiscountsValueDiscountResponseDTO
...
### getAmount
    ...
    string Mindbox\DTO\V2\Responses\PossibleDiscountsValueDiscountResponseDTO::getAmount()
...
### getAmountType
    ...
    string Mindbox\DTO\V2\Responses\PossibleDiscountsValueDiscountResponseDTO::getAmountType()
