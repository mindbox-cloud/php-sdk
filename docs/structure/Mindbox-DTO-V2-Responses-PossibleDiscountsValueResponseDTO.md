Mindbox\DTO\V2\Responses\PossibleDiscountsValueResponseDTO
===============
...
* Class name: PossibleDiscountsValueResponseDTO
...
### $items
    ...
    public \Mindbox\DTO\V2\Responses\PossibleDiscountsValueItemResponseCollection $items
...
### $discount
    ...
    public \Mindbox\DTO\V2\Responses\PossibleDiscountsValueDiscountResponseDTO $discount
...
### getDiscount
    ...
    \Mindbox\DTO\V2\Responses\PossibleDiscountsValueDiscountResponseDTO Mindbox\DTO\V2\Responses\PossibleDiscountsValueResponseDTO::getDiscount()
...
### getItemsCount
    ...
    string Mindbox\DTO\V2\Responses\PossibleDiscountsValueResponseDTO::getItemsCount()
...
### getItems
    ...
    \Mindbox\DTO\V2\Responses\PossibleDiscountsValueItemResponseCollection Mindbox\DTO\V2\Responses\PossibleDiscountsValueResponseDTO::getItems()
