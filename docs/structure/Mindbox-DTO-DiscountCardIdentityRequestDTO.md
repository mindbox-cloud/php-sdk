Mindbox\DTO\DiscountCardIdentityRequestDTO
===============
...
### setId
    ...
    mixed Mindbox\DTO\DiscountCardIdentityRequestDTO::setId(string $name, mixed $value)
...
### setIds
    ...
    mixed Mindbox\DTO\DiscountCardIdentityRequestDTO::setIds(array $ids)
