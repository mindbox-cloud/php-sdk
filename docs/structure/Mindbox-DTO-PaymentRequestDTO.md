...
* Parent class: [Mindbox\DTO\PaymentDTO](Mindbox-DTO-PaymentDTO.md)
...
* Visibility: **public**
* This property is defined by [Mindbox\DTO\PaymentDTO](Mindbox-DTO-PaymentDTO.md)
...
### setType
    ...
    mixed Mindbox\DTO\PaymentRequestDTO::setType(mixed $type)
...
### setId
    ...
    mixed Mindbox\DTO\PaymentRequestDTO::setId(mixed $id)
...
### setAmount
    ...
    mixed Mindbox\DTO\PaymentRequestDTO::setAmount(mixed $amount)
...
### getType
    ...
    string Mindbox\DTO\PaymentDTO::getType()
...
* Visibility: **public**
* This method is defined by [Mindbox\DTO\PaymentDTO](Mindbox-DTO-PaymentDTO.md)
...
### getId
    ...
    string Mindbox\DTO\PaymentDTO::getId()
...
### getAmount
    ...
    string Mindbox\DTO\PaymentDTO::getAmount()
