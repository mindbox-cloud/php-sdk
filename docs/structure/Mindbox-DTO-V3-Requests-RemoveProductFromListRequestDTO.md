Mindbox\DTO\V3\Requests\RemoveProductFromListRequestDTO
===============
...
* Class name: RemoveProductFromListRequestDTO
...
### getProduct
    ...
    \Mindbox\DTO\V3\Requests\ProductRequestDTO Mindbox\DTO\V3\Requests\RemoveProductFromListRequestDTO::getProduct()
...
### setProduct
    ...
    mixed Mindbox\DTO\V3\Requests\RemoveProductFromListRequestDTO::setProduct(array|\Mindbox\DTO\V3\Requests\ProductRequestDTO $product)
