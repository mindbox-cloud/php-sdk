Mindbox\DTO\PaymentInfoResponseDTO
===============
...
### 
    ...
    public \Mindbox\DTO\GiftCardResponseDTO 
...
### getType
    ...
    string Mindbox\DTO\PaymentInfoResponseDTO::getType()
...
### getAvailableAmountForCurrentOrder
    ...
    string Mindbox\DTO\PaymentInfoResponseDTO::getAvailableAmountForCurrentOrder()
...
### getGiftCard
    ...
    \Mindbox\DTO\GiftCardResponseDTO Mindbox\DTO\PaymentInfoResponseDTO::getGiftCard()
