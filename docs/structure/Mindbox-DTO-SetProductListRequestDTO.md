Mindbox\DTO\SetProductListRequestDTO
===============
...
### $products
    ...
    public \Mindbox\DTO\ProductListItemRequestCollection $products
...
### getProducts
    ...
    \Mindbox\DTO\ProductListItemRequestCollection Mindbox\DTO\SetProductListRequestDTO::getProducts()
...
### setProducts
    ...
    mixed Mindbox\DTO\SetProductListRequestDTO::setProducts(array|\Mindbox\DTO\ProductListItemRequestCollection $products)
...
#### Arguments
* $products **array|[array](Mindbox-DTO-ProductListItemRequestCollection.md)**
