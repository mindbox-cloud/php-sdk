...
* Parent class: [Mindbox\DTO\AreaDTO](Mindbox-DTO-AreaDTO.md)
...
### setName
    ...
    mixed Mindbox\DTO\AreaRequestDTO::setName(mixed $name)
...
### setId
    ...
    mixed Mindbox\DTO\AreaRequestDTO::setId(string $name, mixed $value)
...
### setIds
    ...
    mixed Mindbox\DTO\AreaRequestDTO::setIds(array $ids)
...
### getName
    ...
    string Mindbox\DTO\AreaDTO::getName()
...
* Visibility: **public**
* This method is defined by [Mindbox\DTO\AreaDTO](Mindbox-DTO-AreaDTO.md)
