Mindbox\DTO\V3\Requests\AreaRequestDTO
===============
...
* Parent class: [Mindbox\DTO\V3\AreaDTO](Mindbox-DTO-V3-AreaDTO.md)
...
* Visibility: **public**
* This property is defined by [Mindbox\DTO\V3\AreaDTO](Mindbox-DTO-V3-AreaDTO.md)
...
### setName
    ...
    mixed Mindbox\DTO\V3\Requests\AreaRequestDTO::setName(mixed $name)
...
### setId
    ...
    mixed Mindbox\DTO\V3\Requests\AreaRequestDTO::setId(string $name, mixed $value)
...
### setIds
    ...
    mixed Mindbox\DTO\V3\Requests\AreaRequestDTO::setIds(array $ids)
...
### getName
    ...
    string Mindbox\DTO\V3\AreaDTO::getName()
...
* Visibility: **public**
* This method is defined by [Mindbox\DTO\V3\AreaDTO](Mindbox-DTO-V3-AreaDTO.md)
...
### getId
    ...
    string|null Mindbox\DTO\V3\AreaDTO::getId(string $name)
...
### getIds
    ...
    mixed Mindbox\DTO\V3\AreaDTO::getIds()
