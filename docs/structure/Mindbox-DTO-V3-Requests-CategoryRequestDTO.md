Mindbox\DTO\V3\Requests\CategoryRequestDTO
===============
...
### setId
    ...
    mixed Mindbox\DTO\V3\Requests\CategoryRequestDTO::setId(string $name, mixed $value)
...
### setIds
    ...
    mixed Mindbox\DTO\V3\Requests\CategoryRequestDTO::setIds(array $ids)
