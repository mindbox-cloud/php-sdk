Mindbox\DTO\V3\Responses\CategoryResponseDTO
===============
...
* Class name: CategoryResponseDTO
...
### getId
    ...
    string|null Mindbox\DTO\V3\Responses\CategoryResponseDTO::getId(string $name)
...
### getIds
    ...
    mixed Mindbox\DTO\V3\Responses\CategoryResponseDTO::getIds()
