Mindbox\DTO\V3\Responses\OrderResponseDTO
===============
...
### $lines
    ...
    public \Mindbox\DTO\V3\Responses\LineResponseCollection $lines
...
### $payments
    ...
    public \Mindbox\DTO\V3\Responses\PaymentResponseCollection $payments
...
### getIsCurrentState
    ...
    string Mindbox\DTO\V3\Responses\OrderResponseDTO::getIsCurrentState()
...
### getLines
    ...
    \Mindbox\DTO\V3\Responses\LineResponseCollection Mindbox\DTO\V3\Responses\OrderResponseDTO::getLines()
...
### getAppliedPromotions
    ...
    \Mindbox\DTO\V3\Responses\AppliedPromotionResponseCollection Mindbox\DTO\V3\Responses\OrderResponseDTO::getAppliedPromotions()
...
### getPayments
    ...
    \Mindbox\DTO\V3\Responses\PaymentResponseCollection Mindbox\DTO\V3\Responses\OrderResponseDTO::getPayments()
...
### getTotalPrice
    ...
    string Mindbox\DTO\V3\Responses\OrderResponseDTO::getTotalPrice()
...
### getId
    ...
    string|null Mindbox\DTO\V3\Responses\OrderResponseDTO::getId(string $name)
...
### getIds
    ...
    mixed Mindbox\DTO\V3\Responses\OrderResponseDTO::getIds()
