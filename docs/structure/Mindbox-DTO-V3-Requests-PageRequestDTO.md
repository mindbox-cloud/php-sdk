Mindbox\DTO\V3\Requests\PageRequestDTO
===============
...
### getSinceDateTimeUtc
    ...
    string Mindbox\DTO\V3\Requests\PageRequestDTO::getSinceDateTimeUtc()
...
### setSinceDateTimeUtc
    ...
    mixed Mindbox\DTO\V3\Requests\PageRequestDTO::setSinceDateTimeUtc(mixed $sinceDateTimeUtc)
...
#### Arguments
* $sinceDateTimeUtc **mixed**



### getTillDateTimeUtc

    string Mindbox\DTO\V3\Requests\PageRequestDTO::getTillDateTimeUtc()
...
### setTillDateTimeUtc
    ...
    mixed Mindbox\DTO\V3\Requests\PageRequestDTO::setTillDateTimeUtc(mixed $tillDateTimeUtc)
...
#### Arguments
* $tillDateTimeUtc **mixed**



### getPageNumber

    string Mindbox\DTO\V3\Requests\PageRequestDTO::getPageNumber()
...
### setPageNumber
    ...
    mixed Mindbox\DTO\V3\Requests\PageRequestDTO::setPageNumber(mixed $pageNumber)
...
### getItemsPerPage
    ...
    string Mindbox\DTO\V3\Requests\PageRequestDTO::getItemsPerPage()
...
### setItemsPerPage
    ...
    mixed Mindbox\DTO\V3\Requests\PageRequestDTO::setItemsPerPage(mixed $itemsPerPage)
