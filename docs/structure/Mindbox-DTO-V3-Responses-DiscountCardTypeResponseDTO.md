Mindbox\DTO\V3\Responses\DiscountCardTypeResponseDTO
===============
...
* Class name: DiscountCardTypeResponseDTO
...
### getName
    ...
    string Mindbox\DTO\V3\Responses\DiscountCardTypeResponseDTO::getName()
...
### getId
    ...
    string|null Mindbox\DTO\V3\Responses\DiscountCardTypeResponseDTO::getId(string $name)
...
### getIds
    ...
    mixed Mindbox\DTO\V3\Responses\DiscountCardTypeResponseDTO::getIds()
