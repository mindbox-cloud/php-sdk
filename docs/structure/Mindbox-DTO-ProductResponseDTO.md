...
* Parent class: [Mindbox\DTO\ProductIdentityResponseDTO](Mindbox-DTO-ProductIdentityResponseDTO.md)
...
### getSku
    ...
    \Mindbox\DTO\SkuResponseDTO Mindbox\DTO\ProductResponseDTO::getSku()
...
### getCategories
    ...
    \Mindbox\DTO\CategoryResponseCollection Mindbox\DTO\ProductResponseDTO::getCategories()
...
### getPrice
    ...
    string Mindbox\DTO\ProductResponseDTO::getPrice()
...
### getName
    ...
    string Mindbox\DTO\ProductResponseDTO::getName()
...
### getDescription
    ...
    string Mindbox\DTO\ProductResponseDTO::getDescription()
...
### getIsAvailable
    ...
    string Mindbox\DTO\ProductResponseDTO::getIsAvailable()
...
### getOldPrice
    ...
    string Mindbox\DTO\ProductResponseDTO::getOldPrice()
...
### getShelfLife
    ...
    string Mindbox\DTO\ProductResponseDTO::getShelfLife()
...
### getUrl
    ...
    string Mindbox\DTO\ProductResponseDTO::getUrl()
...
### getPictureUrl
    ...
    string Mindbox\DTO\ProductResponseDTO::getPictureUrl()
