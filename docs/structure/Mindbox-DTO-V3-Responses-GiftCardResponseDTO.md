Mindbox\DTO\V3\Responses\GiftCardResponseDTO
===============
...
### $product
    ...
    public \Mindbox\DTO\V3\Responses\ProductResponseDTO $product
...
### $status
    ...
    public \Mindbox\DTO\V3\Responses\GiftCardStatusResponseDTO $status
...
### getProduct
    ...
    \Mindbox\DTO\V3\Responses\ProductResponseDTO Mindbox\DTO\V3\Responses\GiftCardResponseDTO::getProduct()
...
### getAmount
    ...
    string Mindbox\DTO\V3\Responses\GiftCardResponseDTO::getAmount()
...
### getStatus
    ...
    \Mindbox\DTO\V3\Responses\GiftCardStatusResponseDTO Mindbox\DTO\V3\Responses\GiftCardResponseDTO::getStatus()
...
### getBasePricePerItem
    ...
    string Mindbox\DTO\V3\Responses\GiftCardResponseDTO::getBasePricePerItem()
