...
* Parent class: [Mindbox\DTO\SkuIdentityRequestDTO](Mindbox-DTO-SkuIdentityRequestDTO.md)
...
* Visibility: **public**
* This property is defined by [Mindbox\DTO\SkuIdentityDTO](Mindbox-DTO-SkuIdentityDTO.md)
...
### setProductId
    ...
    mixed Mindbox\DTO\SkuRequestDTO::setProductId(mixed $productId)
...
### setBasePricePerItem
    ...
    mixed Mindbox\DTO\SkuRequestDTO::setBasePricePerItem(mixed $basePricePerItem)
...
### setSkuId
    ...
    mixed Mindbox\DTO\SkuRequestDTO::setSkuId(mixed $skuId)
...
### getProductId
    ...
    string Mindbox\DTO\SkuRequestDTO::getProductId()
...
### getBasePricePerItem
    ...
    string Mindbox\DTO\SkuRequestDTO::getBasePricePerItem()
...
### getSkuId
    ...
    string Mindbox\DTO\SkuRequestDTO::getSkuId()
...
* Visibility: **public**
* This method is defined by [Mindbox\DTO\SkuIdentityRequestDTO](Mindbox-DTO-SkuIdentityRequestDTO.md)
...
### setIds
    ...
    mixed Mindbox\DTO\SkuIdentityRequestDTO::setIds(array $ids)
...
* Visibility: **public**
* This method is defined by [Mindbox\DTO\SkuIdentityDTO](Mindbox-DTO-SkuIdentityDTO.md)
