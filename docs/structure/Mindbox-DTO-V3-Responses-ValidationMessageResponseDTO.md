Mindbox\DTO\V3\Responses\ValidationMessageResponseDTO
===============
...
* Class name: ValidationMessageResponseDTO
...
### getMessage
    ...
    string Mindbox\DTO\V3\Responses\ValidationMessageResponseDTO::getMessage()
...
### getLocation
    ...
    string Mindbox\DTO\V3\Responses\ValidationMessageResponseDTO::getLocation()
