Mindbox\DTO\V3\Responses\IssuedCouponResponseDTO
===============
...
* Class name: IssuedCouponResponseDTO
* Namespace: Mindbox\DTO\V3\Responses
* Parent class: [Mindbox\DTO\V3\Responses\CouponResponseDTO](Mindbox-DTO-V3-Responses-CouponResponseDTO.md)
...
* Visibility: **public**
* This property is defined by [Mindbox\DTO\V3\Responses\CouponResponseDTO](Mindbox-DTO-V3-Responses-CouponResponseDTO.md)


### $pool

    public \Mindbox\DTO\V3\Responses\CouponPoolResponseDTO $pool
...
### getPool
    ...
    \Mindbox\DTO\V3\Responses\CouponPoolResponseDTO Mindbox\DTO\V3\Responses\CouponResponseDTO::getPool()
...
* Visibility: **public**
* This method is defined by [Mindbox\DTO\V3\Responses\CouponResponseDTO](Mindbox-DTO-V3-Responses-CouponResponseDTO.md)
...
### getId
    ...
    string|null Mindbox\DTO\V3\Responses\CouponResponseDTO::getId(string $name)
...
### getIds
    ...
    mixed Mindbox\DTO\V3\Responses\CouponResponseDTO::getIds()
