Mindbox\DTO\V3\Responses\BalanceResponseDTO
===============
...
### getTotalValue
    ...
    string Mindbox\DTO\V3\Responses\BalanceResponseDTO::getTotalValue()
...
### getAvailableValue
    ...
    string Mindbox\DTO\V3\Responses\BalanceResponseDTO::getAvailableValue()
...
### getBlockedValue
    ...
    string Mindbox\DTO\V3\Responses\BalanceResponseDTO::getBlockedValue()
