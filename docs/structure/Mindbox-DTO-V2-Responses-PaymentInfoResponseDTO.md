Mindbox\DTO\V2\Responses\PaymentInfoResponseDTO
===============
...
* Class name: PaymentInfoResponseDTO
...
### getType
    ...
    string Mindbox\DTO\V2\Responses\PaymentInfoResponseDTO::getType()
...
### getAvailableAmountForCurrentOrder
    ...
    string Mindbox\DTO\V2\Responses\PaymentInfoResponseDTO::getAvailableAmountForCurrentOrder()
...
### getGiftCard
    ...
    \Mindbox\DTO\V2\Responses\GiftCardResponseDTO Mindbox\DTO\V2\Responses\PaymentInfoResponseDTO::getGiftCard()
