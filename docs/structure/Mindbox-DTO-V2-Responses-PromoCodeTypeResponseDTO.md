Mindbox\DTO\V2\Responses\PromoCodeTypeResponseDTO
===============
...
* Class name: PromoCodeTypeResponseDTO
...
### getName
    ...
    string Mindbox\DTO\V2\Responses\PromoCodeTypeResponseDTO::getName()
...
### getDescription
    ...
    string Mindbox\DTO\V2\Responses\PromoCodeTypeResponseDTO::getDescription()
...
### getId
    ...
    string|null Mindbox\DTO\V2\Responses\PromoCodeTypeResponseDTO::getId(string $name)
...
### getIds
    ...
    mixed Mindbox\DTO\V2\Responses\PromoCodeTypeResponseDTO::getIds()
