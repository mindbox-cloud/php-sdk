Mindbox\DTO\GiftCardResponseDTO
===============
...
* Parent class: [Mindbox\DTO\GiftCardDTO](Mindbox-DTO-GiftCardDTO.md)
...
### $balance
    ...
    public \Mindbox\DTO\BalanceGiftCardResponseDTO $balance
...
* Visibility: **public**
* This property is defined by [Mindbox\DTO\GiftCardDTO](Mindbox-DTO-GiftCardDTO.md)
...
### getStatus
    ...
    string Mindbox\DTO\GiftCardResponseDTO::getStatus()
...
### getBalance
    ...
    \Mindbox\DTO\BalanceGiftCardResponseDTO Mindbox\DTO\GiftCardResponseDTO::getBalance()
...
### getId
    ...
    string Mindbox\DTO\GiftCardDTO::getId()
...
* Visibility: **public**
* This method is defined by [Mindbox\DTO\GiftCardDTO](Mindbox-DTO-GiftCardDTO.md)
...
### getGetFromPool
    ...
    string Mindbox\DTO\GiftCardDTO::getGetFromPool()
