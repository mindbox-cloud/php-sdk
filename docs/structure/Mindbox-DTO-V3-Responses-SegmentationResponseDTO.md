Mindbox\DTO\V3\Responses\SegmentationResponseDTO
===============
...
* Class name: SegmentationResponseDTO
...
### getName
    ...
    string Mindbox\DTO\V3\Responses\SegmentationResponseDTO::getName()
...
### getId
    ...
    string|null Mindbox\DTO\V3\Responses\SegmentationResponseDTO::getId(string $name)
...
### getIds
    ...
    mixed Mindbox\DTO\V3\Responses\SegmentationResponseDTO::getIds()
